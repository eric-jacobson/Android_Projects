...
//            msg.forEach { if(msg.) }
    ...
    private fun showImage(uri:Uri) {
        try {
            ...
            Log.i(TAG,"Byte counts are: $w1 and $w2, width = $wid")
    ...
    fun readMessage(reader: JsonReader): String {
        ...
        while (reader.hasNext()) {
            when (reader.nextName()) {
                ...
                "mid" -> mid = reader.nextString()
                "score" -> score = reader.nextDouble()
                "topicality" -> topicality = reader.nextDouble()
    ...
    companion object {
        ...
        private const val API_KEY = "AIzaSyCfP1roKFEfF-vKUKVd1M8IkdIjdHo1u7E"//your API Key should be placed here
    }
